...
class ProgressPublisher:
    ...
    def publish_judging_completed(self, submission_id: int, username: str, final_status: str):
        self._publish_progress(submission_id, username, final_status, 100)

    def _publish_progress(self, submission_id: int, username: str, status: str, progress_percent: int, current_test: int = 0,total_tests: int = 0):
        message = {
